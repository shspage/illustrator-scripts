...
// ----
// noiseRotate
// changes the rotation of the selected items using Simplex noise.
...
(function(){
    ...
    // rotate options (by my preference)
    var _rotateOpt = {
        changePositions:true,
        changeFillPatterns:true,
        changeFillGradients:true,
        changeStrokePattern:true,
        rotateAbout:Transformation.CENTER
    };
    
    var main = function(){
        var script_name = "noiseRotate";
        ...
        var et_range_max = addEditText(win, "rotate max(degree):", "45");
        var et_range_min = addEditText(win, "rotate min(degree):", "-45");
    ...
    var noiseMain = function(){
        ...
        for(var i = 0; i < _items.length; i++){
            ...
            _items[i].rotate(v,
                             _rotateOpt.changePositions,
                             _rotateOpt.changeFillPatterns,
                             _rotateOpt.changeFillGradients,
                             _rotateOpt.changeStrokePattern,
                             _rotateOpt.rotateAbout
                             );
        }
    };
    // -----------------------------------------------
